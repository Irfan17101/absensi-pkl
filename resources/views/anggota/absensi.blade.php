                ...
                <div class="card-header bg-white border-bottom py-3">
                    <div class="d-flex align-items-center">
                        <div class="bg-primary bg-opacity-10 p-2 rounded-circle me-3">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-person-gear text-primary" viewBox="0 0 16 16">
                        ...
                        <div>
                            <h5 class="mb-0 text-dark fw-semibold">Form Edit Anggota</h5>
                            <p class="text-muted small mb-0">ID: {{ $anggota->id }}</p>
                        </div>
                    </div>
                </div>
                    ...
                    <form method="POST" action="/admin/anggota/{{ $anggota->id }}" id="editAnggotaForm">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="email" 
                                   ...
                                   title="Format email harus valid (contoh: user@domain.com)">
                            @error('email')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-4">
                            ...
                            @enderror
                            <div class="form-text">Pilih role untuk menentukan hak akses</div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            @enderror
                            <div class="form-text">Password minimal 8 karakter. Biarkan kosong jika tidak ingin mengubah.</div>
                        </div>
                        ...
                        <div class="d-flex gap-2 pt-4 border-top">
                            ...
                            <a href="/admin/anggota" class="btn btn-outline-secondary px-4">
            ...
            <div class="card card-elevated border-0 mb-4">
                <div class="card-header bg-white border-bottom py-3">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h5 class="mb-0 text-dark fw-semibold">Informasi Anggota</h5>
                            <p class="text-muted small mb-0">Data saat ini</p>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="d-flex align-items-center mb-3">
                            <div class="flex-shrink-0 bg-light rounded p-2 me-3">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-person-badge text-dark" viewBox="0 0 16 16">
                                    <path d="M6.5 2a.5.5 0 0 0 0 1h3a.5.5 0 0 0 0-1h-3zM11 8a3 3 0 1 1-6 0 3 3 0 0 1 6 0z"/>
                                    <path d="M4.5 0A2.5 2.5 0 0 0 2 2.5V14a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V2.5A2.5 2.5 0 0 0 11.5 0h-7zM3 2.5A1.5 1.5 0 0 1 4.5 1h7A1.5 1.5 0 0 1 13 2.5v10.795a4.2 4.2 0 0 0-.776-.492C11.392 12.387 10.063 12 8 12s-3.392.387-4.224.803a4.2 4.2 0 0 0-.776.492V2.5z"/>
                                </svg>
                            </div>
                        ...
                        <div class="d-flex align-items-center mb-3">
                            <div class="flex-shrink-0 bg-light rounded p-2 me-3">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-calendar-date text-dark" viewBox="0 0 16 16">
                        ...
                        <div class="d-flex align-items-center">
                            <div class="flex-shrink-0 bg-light rounded p-2 me-3">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-clock-history text-dark" viewBox="0 0 16 16">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <div class="fw-medium text-dark">{{ $anggota->updated_at->diffForHumans() }}</div>
                            </div>
                        </div>
                    </div>
